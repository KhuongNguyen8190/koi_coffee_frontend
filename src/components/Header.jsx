...
// 🚀 IMPORT LOGO TỪ THƯ MỤC SRC
import logoImg from '../img/Koi_Logo.png';
        ...
        <>
            <header className="bg-white border-b border-slate-200 px-3 md:px-6 py-2.5 md:py-4 flex justify-between items-center shadow-sm shrink-0 relative z-[60] w-full">
                ...
                <div className="flex items-center gap-2 md:gap-3 shrink-0">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-emerald-600 rounded-lg md:rounded-xl flex items-center justify-center overflow-hidden shadow-md shrink-0">
                        {/* 🚀 ĐÃ CẬP NHẬT GẮN LOGO Ở ĐÂY */}
                        <img src={logoImg} alt="Koi Coffee Logo" className="w-full h-full object-cover" />
                    </div>
